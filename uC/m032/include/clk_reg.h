...
#define CLK_CLKSEL1_TMR_SRC_HXT 0
#define CLK_CLKSEL1_TMR_SRC_PLL 1
#define CLK_CLKSEL1_TMR_SRC_PCLK0 2
#define CLK_CLKSEL1_TMR_SRC_TM0_PIN 3
#define CLK_CLKSEL1_TMR_SRC_LIRC 5
#define CLK_CLKSEL1_TMR_SRC_HIRC 7
